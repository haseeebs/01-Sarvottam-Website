      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='space-y-12'>
          {services.map((service, index) => (
            ...
            >
              {/* Image Container (50% width on medium screens and up) */}
              <div
                className={cn('w-full flex-shrink-0 overflow-hidden md:w-1/2', {
                  'md:order-last': index % 2 !== 0, // Image ko alternate karega (left/right)
                })}
              >
                <img
                  src={service.imgSrc}
              ...
              {/* Content Container (50% width on medium screens and up) */}
              <div className='flex w-full flex-grow flex-col justify-center p-8 md:w-1/2 md:p-10'>
                ...
                {/* Minimal "Learn More" - Hamesha visible, hover par color badlega */}
