  ...
  return (
    <section className="bg-slate-100 py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-2 gap-y-12 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-8">
          {features.map((feature) => (
            ...
            >
              ...
              <h3 className="mt-4 text-xl font-bold text-blue-900 font-serif">
                {feature.name}
              </h3>
            </div>
          ))}
