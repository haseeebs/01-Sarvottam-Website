        ...
        <div className='mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-16 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2'>
          ...
          <div className='lg:pt-4 lg:pr-8'>
            <div className='lg:max-w-lg'>
              <h4 className='font-body text-base leading-7 font-bold text-amber-500'>
          ...
          <img
            ...
            className='w-full max-w-none justify-self-end rounded-sm shadow-xl ring-1 ring-gray-400/10 md:w-[36rem] lg:w-[48rem]'
          />
        </div>
      </div>
    </div>
