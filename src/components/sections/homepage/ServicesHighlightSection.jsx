      ...
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
        <section aria-labelledby="details-heading">
          <div className="flex flex-col items-center text-center">
            <h2
              id="details-heading"
              className="text-3xl font-extrabold tracking-tight text-my-primary sm:text-4xl"
            >
              Our Core Specializations
            </h2>
            <p className="mt-4 max-w-3xl text-lg text-my-secondary">
              Expertise in trenchless technology for modern infrastructure
              challenges.
            </p>
          </div>

          <div className="mt-16 grid grid-cols-1 gap-y-16 sm:grid-cols-2 lg:grid-cols-3 sm:gap-x-8">
            {services.map((service) => (
              ...
              >
                ...
                <div className="mt-6 flex items-start justify-between">
                  <h3 className="text-xl font-bold text-my-primary">
                    {service.title}
                  </h3>
                  <div className="ml-4 flex-shrink-0">
                    <ArrowRight className="h-6 w-6 text-my-secondary transition-transform duration-300 group-hover:translate-x-1 group-hover:text-my-accent" />
                  </div>
                </div>
              </a>
            ))}
