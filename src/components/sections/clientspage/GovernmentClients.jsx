...
const logoSources = {
  ...
  NHAI: "https://upload.wikimedia.org/wikipedia/en/thumb/e/e4/NHAI_Logo.svg/1200px-NHAI_Logo.svg.png",
  GAIL: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/GAIL_Logo.svg/1200px-GAIL_Logo.svg.png",
  ONGC: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/ONGC_Logo.svg/1200px-ONGC_Logo.svg.png",
};
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-12 grid max-w-lg grid-cols-2 items-center gap-x-8 gap-y-12 sm:max-w-xl sm:grid-cols-3 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          {logos.map((logoName) => (
            <img
              key={logoName}
              className="col-span-1 max-h-16 w-full object-contain grayscale transition-all duration-300 ease-in-out hover:grayscale-0 hover:scale-105"
