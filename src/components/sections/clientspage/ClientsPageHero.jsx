      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div className="mx-auto max-w-4xl py-24 sm:py-32">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-blue-900 sm:text-[42px] leading-tight sm:leading-tight">
              {headline}
            </h1>
            <p className="mt-6 max-w-[750px] mx-auto text-lg leading-8 text-slate-700">
              {body}
            </p>
