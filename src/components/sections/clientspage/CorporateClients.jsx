...
const logoSources = {
  ...
  'TATA':
    'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/TATA_logo.svg/1280px-TATA_logo.svg.png',
};
        ...
        <div className='mx-auto mt-12 grid max-w-lg grid-cols-2 items-center gap-x-8 gap-y-12 sm:max-w-xl sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:justify-center'>
          {logos.map((logoName) => (
            <div key={logoName} className='flex justify-center'>
              <img
                className='max-h-16 w-full object-contain grayscale transition-all duration-300 ease-in-out hover:scale-105 hover:grayscale-0'
