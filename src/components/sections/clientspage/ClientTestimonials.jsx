    ...
    <section className="relative isolate overflow-hidden bg-slate-100 px-6 py-24 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-2xl lg:max-w-4xl">
        ...
        <figure className="mt-16">
          <blockquote className="relative text-center text-xl font-medium leading-8 text-slate-800 sm:text-2xl sm:leading-9">
            <div className="absolute -top-4 -left-2 sm:-left-4 text-8xl font-black text-slate-200/80 -z-10">
              “
            </div>
