...
const buttonVariants = cva(
  'inline-flex items-center justify-center select-none rounded-sm text-sm font-medium ring-offset-background focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
